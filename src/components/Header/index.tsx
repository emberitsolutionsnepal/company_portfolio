            ...
            <div className="flex w-full items-center justify-between px-4">
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-black group-hover:text-primary dark:text-white dark:group-hover:text-primary lg:inline-flex lg:px-0 lg:py-6 ${
                            ...
                            <Link
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-black dark:text-white lg:inline-flex lg:px-0 lg:py-6 ${
                                sticky
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center text-black duration-300 dark:text-white"
                >
                  <span>
                    ...
                    <svg
                      viewBox="0 0 23 23"
                      className="block h-[30px] w-[30px] fill-current dark:hidden"
                    >
